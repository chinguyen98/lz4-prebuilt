...
try {
    ...
    function dumpBuffer(buffer, offset, length) {
        const bytes = [];
    ...
    function decompressRawLZ4(input) {
        ...
        for (let attempt = 0; attempt < maxAttempts; attempt++) {
            ...
            try {
                ...
                console.log(`[LZ4] Attempt failed: ${(err === null || err === void 0 ? void 0 : err.message) || 'Unknown error'}`);
